...
exports['insert_aux_schema'] = function (test) {
    ...
    flow.exec(
        function() {
            ...
            test.equal(response.statusCode, 201, "Correct status for auxiliary schema insertion.");
    ...
    flow.exec(
        function() {
            ...
            if (response.statusCode !== 404) {
                ...
                try {
                    tutils.delete_aux_schema(test_ns, aux_schema_name, auth, this );
                } catch (e) {
                    console.log("Problem deleting the test auxiliary schema during cleanup.", e);
                    this();
                }
...
exports['insert_conflicting_aux_schema'] = function (test) {
    ...
    flow.exec(
        function() {
            ...
            tutils.insert_aux_schema(test_ns, aux_schema_doc_dupe, auth, this);
        }, function(data, response) {
...
function invalid_credentials_helper(test, test_auth) {
    ...
    flow.exec(
        function() {
            ...
            tutils.insert_aux_schema(test_ns, aux_schema_doc, test_auth, this);
        }, function(data, response) {
