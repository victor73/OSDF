...
Example Response:	{	  "<ns1>":     { "title": "<title1>",	                 "description": "<description1>",	                 "url": "<url1>" },		  "<ns2>":     { "title": "<title2>",	                 "description": "<description2>",	                 "url": "<url2>" },		  "<nsN>":     { "title": "<titleN>",	                 "description": "<descriptionN>",	                 "url": "<urlN>" }	}Concrete Example Response:	{	    "bio": {	        "title": "The Bio Project",	        "description": "The aim Bio Project is to...",	        "url": "http://bio.example.org"	    }	}
...
Example Response:	{	    "<ns>": {	        "title": "<title>",	        "description": "<description>",	        "url": "<url>"	    }	}Concrete Example Response:	{	    "bio": {	        "title": "The Bio Project",	        "description": "The aim of the Bio Project is to...",	        "url": "http://bio.example.org"	    }	}
...
**Response:**Returns HTTP 201 ("Created") on success. Failed requests, because of a invalid or malformed JSON, will yield HTTP 422 ("Unprocessable Entity"). Error details may be found in the X-OSDF-Error HTTP header. Other errors may result in HTTP 500 ("Server error") responses.Users attempting to create an ACL without appropriate permissions (write access to the namespace) will receive an HTTP 403 "Forbidden" status code.
