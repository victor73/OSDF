...
describe('aux-schema-delete', function() {
    ...
    it('delete_aux_schema', function(done) {
        ...
        waterfall([
            ...
            function(resp, callback) {
                ...
                assert.isOk(data.length > 0, 'Data returned on deletion.');
            ...
            function(resp, callback) {
                ...
                assert.isOk(data.length > 0,
                    'Got data for auxiliary schema listing.');
    ...
    it('delete_aux_schema_in_use', function(done) {
        ...
        waterfall([
            ...
            function(resp, callback) {
                ...
                assert.strictEqual(data.length, 0,
                    'No data returned on deletion attempt.');
            ...
            function(resp, callback) {
                ...
                // flagged a failure and the server ALLOWED the schema to be
                // deleted. If that were the case, this hnext deletion would be
    ...
    // Test deletion of an auxiliary schema when no authentication credentials
    // are provided. We should not be able to delete an auxiliary schema this
    // way.
    it('delete_aux_schema_no_auth', function(done) {
    ...
    // Test deletion of an auxiliary schema when invalid authentication
    // credentials are provided. We should not be able to delete an auxiliary
    // schema this way.
    it('delete_aux_schema_bad_auth', function(done) {
        // Use a helper function since the delete_aux_schema_no_auth()
        // and delete_aux_schema_bad_auth() tests are so similar.
