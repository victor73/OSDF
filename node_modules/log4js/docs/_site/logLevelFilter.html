...
<html>
  <head>
    ...
    <link rel="stylesheet" href="/assets/css/style.css?v=bff675fd9bf899310948b0dbc1821ef4b3f88a88">
...
<div class="language-javascript highlighter-rouge"><pre class="highlight"><code><span class="nx">log4js</span><span class="p">.</span><span class="nx">configure</span><span class="p">({</span>
  <span class="na">appenders</span><span class="p">:</span> <span class="p">{</span>
    ...
    <span class="nx">just</span><span class="o">-</span><span class="na">errors</span><span class="p">:</span> <span class="p">{</span> <span class="na">type</span><span class="p">:</span> <span class="s1">'logLevelFilter'</span><span class="p">,</span> <span class="na">appender</span><span class="p">:</span> <span class="p">[</span><span class="s1">'emergencies'</span><span class="p">],</span> <span class="na">level</span><span class="p">:</span> <span class="s1">'error'</span> <span class="p">}</span>
  <span class="p">},</span>
