...
<div class="language-javascript highlighter-rouge"><pre class="highlight"><code><span class="nx">log4js</span><span class="p">.</span><span class="nx">configure</span><span class="p">({</span>
  <span class="na">appenders</span><span class="p">:</span> <span class="p">{</span>
    ...
    <span class="s1">'just-errors'</span><span class="p">:</span> <span class="p">{</span> <span class="na">type</span><span class="p">:</span> <span class="s1">'logLevelFilter'</span><span class="p">,</span> <span class="na">appender</span><span class="p">:</span> <span class="s1">'emergencies'</span><span class="p">,</span> <span class="na">minLevel</span><span class="p">:</span> <span class="s1">'error'</span> <span class="p">}</span>
  <span class="p">},</span>
